...
import { ArrowUpRight, ExternalLink, CheckCircle } from "lucide-react";
            ...
            <FadeIn key={project.id} delay={i * 0.08}>
              <GlassCard className="overflow-hidden p-0 h-full flex flex-col group">
                <div className="relative aspect-video overflow-hidden">
                  <AppImage src={project.image} alt={project.name} fill className="object-cover group-hover:scale-105 transition-transform duration-500" sizes="33vw" />
                  {project.featured && (
